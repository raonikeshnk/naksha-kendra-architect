...
const About = () => {
  ...
  const whyChooseUs = ["Professional architectural expertise with years of experience", "Custom design solutions tailored to your specific needs", "Timely project delivery with transparent communication", "Turnkey projects", "Competitive pricing without compromising on quality", "Local expertise with deep understanding of regional requirements", "Comprehensive services from planning to execution"];
  return <div className="min-h-screen bg-accent">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <img src="https://images.unsplash.com/photo-1449157291145-7efd050a4d0e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Modern Architecture" className="w-full h-96 object-cover rounded-xl shadow-lg" />
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {values.map((value, index) => <Card key={index} className="text-center border-0 shadow-lg">
                <CardHeader>
      ...
      <section className="py-20 bg-accent">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {whyChooseUs.map((reason, index) => <div key={index} className="flex items-start space-x-4 p-6 bg-white rounded-lg shadow-sm">
      ...
      <section className="py-20 bg-primary">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <a href="/contact" className="bg-secondary text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-secondary/90 transition-colors inline-block">
            Start Your Project
          </a>
        </div>
      </section>
